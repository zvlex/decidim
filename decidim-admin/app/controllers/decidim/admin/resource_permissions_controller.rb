...
module Decidim
  module Admin
    ...
    class ResourcePermissionsController < Decidim::Admin::ApplicationController
      ...
      def edit
        # enforce_permission_to :edit, resource_symbol, resource_symbol => resource
      ...
      def update
        # enforce_permission_to :update, resource_symbol, resource_symbol => resource
      ...
      def return_path
        ...
        # EngineRouter.admin_proxy(resource).root_path#(locale: current_params[:locale])
      end
